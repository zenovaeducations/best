...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        try {
            ...
            const applyingForValue =
                document
                    .getElementById("applyingFor")
                    .value;
            ...
            const previousInstitution =
                document
                    .getElementById("previousInstitution")
                    .value
                    .trim();
